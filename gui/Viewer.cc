...
// Viewer::Viewer(std::shared_ptr<FrameDrawer> pFrameDrawer,
...
void Viewer::Run() {
  ...
  pangolin::Var<bool> menuDrawCurrentCamera("menu.Show Current Camera", true,
                                            true);
  ...
  while (1) {
    ...
    if (menuDrawCurrentCamera)
      mpMapDrawer->DrawCurrentCamera(Twc);
    clock_t end = clock();
    I3D_LOG(i3d::detail) << "Time for drawing: "
